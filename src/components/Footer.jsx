  ...
  return (
    <footer className=" bg-slate-500  bottom-0 top-0 z-10 grow-1">
        ...
        <Link
         target='iframe'
          to="/"
          className=" inline-flex items-center bg-gray-600 font-bold border-0 py-1 px-3 focus:outline-none hover:bg-gray-700 rounded hover:text-white text-white text-base mt-4 md:mt-0">
          retour a l'accueil
